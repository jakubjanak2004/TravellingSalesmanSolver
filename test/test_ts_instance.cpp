...
TEST_CASE("Test Solve Correctness", "[all]") {
    ...
    SECTION("K(5)") {
        instance = helper::create_synthetic_instance(5);
    ...
    SECTION("K(6)") {
        instance = helper::create_synthetic_instance(6);
        const std::set<std::vector<node> > solveResult = helper::convert_to_node_set(instance->solve());
        const std::set<std::vector<node> > bruteForceResult = helper::convert_to_node_set(instance->brute_force_solve());
    ...
    SECTION("K(7)") {
        instance = helper::create_synthetic_instance(7);
        const std::set<std::vector<node> > solveResult = helper::convert_to_node_set(instance->solve());
        const std::set<std::vector<node> > bruteForceResult = helper::convert_to_node_set(instance->brute_force_solve());
    ...
    SECTION("K(8)") {
        instance = helper::create_synthetic_instance(8);
        const std::set<std::vector<node> > solveResult = helper::convert_to_node_set(instance->solve());
        const std::set<std::vector<node> > bruteForceResult = helper::convert_to_node_set(instance->brute_force_solve());
    ...
    SECTION("K(9)") {
        instance = helper::create_synthetic_instance(9);
        const std::set<std::vector<node> > solveResult = helper::convert_to_node_set(instance->solve());
        const std::set<std::vector<node> > bruteForceResult = helper::convert_to_node_set(instance->brute_force_solve());
